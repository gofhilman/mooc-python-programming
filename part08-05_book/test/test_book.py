...
"""
    ...
    def test2_constructor(self):
        try:
            ...
            self.fail(
                'Calling class constructor with Book("Python 1", "Peter Python", "Non-fiction", 2010)'
                + f" threw an error: {e}"
            )
        ...
        with patch(
            ...
            for attr in attributes:
                ...
                self.assertTrue(
                    ...
                    f"Object should have an attribute {attr},"
        ...
        with patch(
            ...
            for attr in attributes:
                ...
                self.assertTrue(
                    ...
                    f"The type of ttribute {name} should be {taip_name}, now it is {taip2}",
                )
