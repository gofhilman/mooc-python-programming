...
class IncorrectLotteryNumbersTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        with patch(
            "builtins.input", side_effect=[AssertionError("Input was not excpected")]
        ):
...
"""
    ...
    def test_2_creates_file(self):
        ...
        try:
            ...
            self.assertTrue(
                False, "Ensure that function filter_incorrect() can be called"
            )
        self.assertTrue(
            file_exists(datafile), f"Program does not create file {datafile} at all."
        )
    ...
    def test_3_correct_content(self):
        ...
        corr = [
            ...
            "week 20;32,28,25,19,4,2,3",
            "week 22;10,23,24,33,31,21,2",
            "week 23;34,28,14,33,18,6,9",
            "week 26;8,17,26,9,28,25,27",
            "week 34;11,4,33,17,37,1,8",
            "week 36;16,4,12,32,19,34,28",
            "week 49;31,22,11,6,33,38,35",
            "week 50;35,5,7,24,8,22,21",
        ]
        for c in corr:
            self.assertTrue(
                c in content,
                f"File {datafile} should contain a line {c} but it is not found.",
            )
    ...
    def test_4_incorrect_content(self):
        ...
        corr = [
            ...
            "week 21;25,8,18,33,13,11",
            "week xx24;37,8,25,30,23,24,19",
            "week 27;11,1,Ccy,31,9,20,24",
            "week rrrsas;29,20,19,5,26,11,36",
            "week **.';32,25,36,28,21,15,9",
            "week cca:mC;12,32,30,28,4,16,20",
            "week 51;rxXX,17,20,27,11,30,5",
            "week 52;29,26,11,21,20,29,5",
            "week 31;6,38,4,-26,32,24,34",
            "week 25;2,25,27,310,8,7,4",
        ]
        for c in corr:
            self.assertFalse(
                c in content, f"File {datafile} should NOT contain an invalid line {c}."
            )
    ...
    def test_5_test_file_length(self):
        ...
        self.assertEqual(
            len(content),
            37,
            f"File {datafile} should contain 37 lines, now there are {len(content)} lines.",
        )
