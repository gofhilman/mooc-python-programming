...
class MatrixTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        with patch(
            "builtins.input", side_effect=[AssertionError("input is not required")]
        ):
...
"""
    ...
    def test_1_functions_exist(self):
        try:
            ...
            self.assertTrue(
                False, f"Your code should have a function called row_sums()"
            )
        try:
            row_sums()
        except:
        ...
        try:
            ...
            self.assertTrue(
                False, f"Your code should have a function called matrix_max"
            )
        try:
            matrix_max()
        except:
        ...
        try:
            ...
            self.assertTrue(
                False, f"Your code should have a function called matrix_sum"
            )
        try:
            matrix_sum()
        except:
    ...
    def test_2_return_types(self):
        ...
        for func in funcs:
            ...
            self.assertTrue(
                type(val) == int,
                f"Funtion {func}() should return an integer, now it returns value {val} which is of type {taip}.",
            )
        ...
        self.assertTrue(
            type(val) == list,
            f"Function row_sums() should return a list, now it returns value {val} which is of type {taip}.",
        )
    ...
    def test_3_test_sum(self):
        ...
        self.assertEqual(
            val,
            correct,
            f"Calling matrix_sum() return value {val}, correct answer is {correct}.",
        )
    ...
    def test_4_testaa_maksimi(self):
        ...
        self.assertEqual(
            val,
            correct,
            f"Calling matrix_max() returns value {val}, correct answer is {correct}.",
        )
    ...
    def test_5_testaa_rivisummat(self):
        ...
        self.assertTrue(
            val == correct,
            f"Calling row_sums() returns valuen\n{val}\ncorrect answer is\n{correct}",
        )
