...
"""
    ...
    def test_1_function_exists(self):
        try:
            ...
            self.assertTrue(
                False,
                f"Your code should contain function named as block_correct(sudoku: list, row_no: int, column_no: int)",
            )
        try:
    ...
    def test_2_type_of_return_value(self):
        ...
        self.assertTrue(
            type(val) == bool,
            f"Function {function} does not return boolean value when calling\n{p(s)}\nblock_correct(sudoku, 0, 0)",
        )
    ...
    def test_3_functionality(self):
        ...
        for row, column in [(0, 3), (0, 6), (3, 0), (3, 3), (6, 6)]:
            ...
            self.assertEqual(
                val,
                True,
                f"The result {val} is incorrect when calling \n{p(s)}\nblock_correct(sudoku, {row}, {column})",
            )
        ...
        for row, column in [(0, 0), (3, 6), (6, 3), (6, 0)]:
            try:
                ...
                self.assertEqual(
                    val,
                    False,
                    f"Make sure, that the function can be called as follows\n{p(s)}\nblock_correct(sudoku, {row}, {column})",
                )
            self.assertEqual(
                val,
                False,
