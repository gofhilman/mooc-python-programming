...
"""
    ...
    def test_1_function_exists(self):
        try:
            ...
            self.assertTrue(
                False,
                f"Your code should contain function named as older_people(people: list, year: int)",
            )
        try:
...
result = older_people(person_list, 2000)"""
        ...
        self.assertTrue(
            type(result) == list,
            f"Function {function} does not return a list when executing the following code:\n{code}",
        )
