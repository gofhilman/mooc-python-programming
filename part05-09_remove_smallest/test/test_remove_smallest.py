...
"""
    ...
    def test_1_function_exists(self):
        try:
            ...
            self.assertTrue(
                False,
                "Your code should contain function named as remove_smallest(luvut: list)",
            )
        try:
            from src.remove_smallest import remove_smallest
    ...
    def test_2_type_of_return_value(self):
        ...
        self.assertTrue(
            val == None,
            f"Function {function} should not return a value, now type of return value is {type(val)}.",
        )
