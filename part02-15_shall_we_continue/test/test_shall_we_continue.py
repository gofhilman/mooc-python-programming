...
class ShallWeContinueTest(unittest.TestCase):
    ...
    def test_1_first(self):
        ...
        with patch("builtins.input", side_effect=values):
            try:
                ...
                self.assertTrue(
                    False,
                    "Make sure that execution of your program stops with the input {}".format(
                        values
                    ),
                )
    ...
    def test_2_one_and_no(self):
        ...
        with patch("builtins.input", side_effect=values):
            ...
            self.assertTrue(
                len(output.split("\n")) == 3,
                "Instead of three rows, your programs output is in {} rows: \n{}\nwhen input is:\n{}".format(
                    len(output.split("\n")), output, p(values)
                ),
            )
            self.assertTrue(
    ...
    def test_3_three_and_no(self):
        ...
        with patch("builtins.input", side_effect=values):
            ...
            self.assertTrue(
                len(output.split("\n")) == 5,
                "Instead of five rows, your programs output is in {} rows: \n{}\nwhen input is:\n{}".format(
                    len(output.split("\n")), output, p(values)
                ),
            )
            self.assertTrue(
    ...
    def test_4_only_no(self):
        ...
        with patch("builtins.input", side_effect=values):
            ...
            self.assertTrue(
                len(output.split("\n")) == 2,
                "Instead of two rows, your programs output is in {} rows: \n{}\nwhen input is:\n{}".format(
                    len(output.split("\n")), output, p(values)
                ),
            )
            self.assertTrue(
