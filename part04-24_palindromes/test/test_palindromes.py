...
class PalindromesTest(unittest.TestCase):
    ...
    def test_1_function_exists(self):
        try:
            ...
            self.assertTrue(
                False,
                "Your code should contain function named as palindromes(word: str)",
            )
        try:
            from src.palindromes import palindromes
    ...
    def test_2_type_of_return_value(self):
        ...
        self.assertTrue(
            type(val) == bool,
            f"Calling {function} does not return value of boolean type with parameter value 'aa'.",
        )
    ...
    def test_3_function(self):
        ...
        for test_case in test_cases:
            ...
            self.assertTrue(
                correct == test_result,
                f'The result of function {test_result} does not match with the model solution {correct} when calling palindromes("{test_case}")',
            )
...
block
            ...
            self.assertFalse(
                len(noutput) == 0,
                f"Your program does not print out anything with the test input\n{ntest_cases}\n{mssage}",
            )
            self.assertTrue(
                correct == output,
