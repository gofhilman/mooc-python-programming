...
"""
    ...
    def test_1_function_exists(self):
        try:
            ...
            self.assertTrue(
                False,
                "Your code should contain function named as formatted(my_list: list)",
            )
        try:
            ...
            self.assertTrue(
                False,
                "Make sure, that function can be called as follows formatted([0.23])",
            )
    ...
    def test_2_type_of_return_value(self):
        ...
        self.assertTrue(
            type(val) == list,
            "Function formatted does not return list with parameter value [1.23].",
        )
