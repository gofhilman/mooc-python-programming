...
exercise = "src.substrings_part_2"
...
@points("3.substrings_part_2")
class Substrings2Test(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        for word in words:
            with patch("builtins.input", return_value=word):
                try:
                    ...
                    self.assertTrue(
                        False,
                        f"Make sure that your program works with the input {word}",
                    )
