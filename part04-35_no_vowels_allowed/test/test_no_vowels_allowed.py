...
"""
    ...
    def test_1_function_exists(self):
        try:
            ...
            self.assertTrue(
                False,
                "Your code should contain function named as no_vowels(my_string: str)",
            )
        try:
            ...
            self.assertTrue(
                False, 'Make sure, that function can be called as no_vowels("abc")'
            )
    ...
    def test_2_type_of_return_value(self):
        ...
        self.assertTrue(
            type(val) == str,
            'Function no_vowels does not return value of string type when calling no_vowels("abc").',
        )
