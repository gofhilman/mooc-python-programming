...
"""
    ...
    def test_1_function_exists(self):
        try:
            ...
            self.fail(
                "Your program should contain a function store_personal_data(person: tuple)"
            )
        try:
            store_personal_data(("Timothy Test", 45, 160.0))
        except Exception as e:
            self.fail(
                "The following function call throws an error store_personal_data(('Timothy Test', 45, 160.0)):\n"
                + e
            )
    ...
    def test_2_write_one_person_1(self):
        ...
        self.assertTrue(
            ...
            f"File {datafile} cannot be found after the function is executed!",
        )
