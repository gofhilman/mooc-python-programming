...
class RowYourBoatTest(unittest.TestCase):
    ...
    def test_content(self):
        ...
        self.assertFalse(
            len(split_output) != 4,
            "Output was expected to have {0} lines, your program's output is now in {1} lines.".format(
                4, len(split_output)
            ),
        )
        assert_ignore_ws(
            ...
            "The print out on the first line is incorrect.",
            "en",
        )
        assert_ignore_ws(
            self,
            ...
            "The print out on the second line is incorrect.",
            "en",
        )
        assert_ignore_ws(
            self,
            ...
            "The print out on the third line is incorrect.",
            "en",
        )
        assert_ignore_ws(
            self,
            split_output[3],
            "Life is but a dream.",
            "The print out on the fourth line is incorrect.",
            "en",
        )
