...
class SoupOrNoSoupTest(unittest.TestCase):
    ...
    def test_1_kramer_1(self):
        with patch(
            ...
            self.assertTrue(
                expected in output,
                f"With input Kramer, 1 your program should print out\n{expected}\nyour program printed out\n"
                + output,
            )
    ...
    def test_2_kramer_4(self):
        with patch(
            ...
            self.assertTrue(
                expected in output,
                f"With input Kramer, 4 your program should print out\n{expected}\nyour program printed out\n"
                + output,
            )
    ...
    def test_3_jerry(self):
        with patch(
            ...
            side_effect=[
                "Jerry",
                AssertionError(
                    "Input was asked too many times when first input was Jerry."
                ),
            ],
        ) as prompt:
            reload_module(self.module)
            ...
            self.assertTrue(
                expected in output,
                f"With input Jerry your program should print out\n{expected}\nyour program printed out\n"
                + output,
            )
    ...
    def test_4_jane_doe(self):
        with patch(
            ...
            side_effect=[
                "Jane Doe",
                "2",
                AssertionError("Input is asked too many times when name is Jane Doe."),
            ],
        ) as prompt:
            reload_module(self.module)
            output = get_stdout().rstrip()
            ...
            self.assertTrue(
                expected in output,
                f"with input Jane Doe, 2 your program should print out\n{expected}\nyour program printed out\n"
                + output,
            )
