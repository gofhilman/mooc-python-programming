...
"""
    ...
    def test_2_first_word_exists(self):
        try:
            ...
            self.assertTrue(
                False, f"Your code should contain function named as first_word"
            )
        try:
            from src.first_second_last import first_word
    ...
    def test_3_first_word_function_ok(self):
        for row in [
            ...
            with patch("builtins.input", side_effect=["2 2"] * 10):
                ...
                self.assertFalse(
                    len(output_all) > 0,
                    f'Calling first_word("{row}") should not print out anything, but it prints out\n{output_all}\nremove print commands inside function',
                )
    ...
    def test_4_second_word_exists(self):
        try:
            ...
            self.assertTrue(
                False, f"Your code should contain function named as second_word"
            )
        try:
            from src.first_second_last import second_word
