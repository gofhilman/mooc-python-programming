...
"""
    ...
    def test2_constructor(self):
        try:
            ...
            self.fail(
                "Calling constructor with DecreasingCounter(1)"
                + f" threw an error: {e}"
            )
        ...
        for test_case in test_cases:
            try:
                ...
                self.assertEqual(
                    counter.value,
                    corr,
                    f"The value of counter should be{corr}, when it was initialized with\n"
                ...
                self.fail(
                    f"Calling method decrease threw an error:\n{e}"
