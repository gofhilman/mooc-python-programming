...
class PhoneBookV2Test(unittest.TestCase):
    ...
    def test_1_program_stops(self):
        ...
        with patch(
            "builtins.input",
            side_effect=["3", AssertionError("Input is asked too many times.")],
        ):
            try:
                ...
                self.assertTrue(
                    False, f"Make sure, that the program stops with the input\n3"
                )
