        ...
        for name, file in [
            ...
            with patch(
                ...
                side_effect=[
                    name,
                    file,
                    AssertionError("Your program has too many inputs"),
                ],
            ):
