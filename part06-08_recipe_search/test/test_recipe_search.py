...
"""
    ...
    def test_1_function_search_by_name_exists(self):
        with patch("builtins.input", side_effect=["recipes1.txt"] * 10):
            ...
            try:
                ...
                self.fail(
                    'Function call search_by_name("test/recipes1.txt", "bun") throws an error:\n'
                    + ioe
                )
    ...
    def test_2_search_by_name_return_type(self):
        with patch("builtins.input", side_effect=["recipes1.txt"] * 10):
            ...
            self.assertTrue(
                type(val) == list,
                f"Function {function1} should return a list, now it returns value {val} which is of type {taip}.",
            )
