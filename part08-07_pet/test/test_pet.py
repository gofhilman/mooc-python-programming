...
"""
    ...
    def test_0b_constructor(self):
        try:
            ...
            self.fail(
                f'Calling constructor Pet("Fluffy","Dog",2014) threw an error \n{e}'
            )
    ...
    def test2_return_type(self):
        try:
            ...
            self.fail(
                'Function threw an error when called like this: new_pet("Fluffy","Dog",2014)'
            )
        taip = str(type(val)).replace("<class '", "").replace("'>", "")
        self.assertTrue(
            "Pet" in str(type(val)),
            f"Function new_pet should return a value of type Pet,"
        ...
        with patch(
            ...
            for attr in attributes:
                ...
                self.assertTrue(
                    ...
                    f"The Pet object should have an attribute {attr},"
    ...
    def test4_test_attribute_types(self):
        with patch(
            ...
            for attr in attributes:
                ...
                taip2 = (
                    str(type(ref.get_attribute(name)))
                    .replace("<class '", "")
                    .replace("'>", "")
                )
                ...
                self.assertTrue(
                    ...
                    f"The type of the attribute {name} should be {taip}, now it is {taip2}",
                )
