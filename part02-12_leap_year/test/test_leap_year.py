    ...
    def test_divisible_by_four(self):
        ...
        for value in values:
            with patch("builtins.input", return_value=value):
                ...
                self.assertTrue(
                    output[0].lower().strip().find("is a leap year") > -1,
                    "Output\n{}\ndoes not match with the correct output\n{}\nwhen input is {}".format(
                        output[0], "That year is a leap year.", value
                    ),
                )
    ...
    def test_not_divisible_by_four(self):
        ...
        for value in values:
            with patch("builtins.input", return_value=value):
                ...
                self.assertTrue(
                    output[0].lower().strip().find("is not a leap year") > -1,
                    "Output\n{}\ndoes not match with the correct output\n{}\nwhen input is {}".format(
                        output[0], "That year is not a leap year.", value
                    ),
                )
