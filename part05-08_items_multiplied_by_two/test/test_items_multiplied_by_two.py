...
"""
    ...
    def test_1_function_exists(self):
        try:
            ...
            self.assertTrue(
                False,
                "Your code should contain function named as double_items(numbers: list)",
            )
        try:
            from src.items_multiplied_by_two import double_items
    ...
    def test_2_type_of_return_value(self):
        ...
        self.assertTrue(
            type(val) == list,
            f"Function {function} does not return value of list type when calling double_items([1]).",
        )
        ...
        for test_case in test_cases:
            with patch(
                ...
                try:
                    ...
                    self.assertTrue(
                        False,
                        f"Make sure, that the function works when the input is\n{test_case2}",
                    )
