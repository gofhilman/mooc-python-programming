        ...
        for value in values:
            with patch("builtins.input", return_value=value):
                ...
                self.assertTrue(
                    ...
                    "Correct integer part {} is not found from output {} with input {}".format(
                        intpart, output[0], value
                    ),
                )
                self.assertTrue(
                    output[1].find(str(decpart)) > -1,
                    "Correct decimal part {} is not found from output {} with input {}".format(
                        decpart, output[0], value
                    ),
                )
