...
"""
    ...
    def test_1_function_exists(self):
        try:
            ...
            self.assertTrue(
                False,
                "Your code should contain function named as distinct_numbers(my_list: list)",
            )
        try:
    ...
    def test_2_type_of_return_value(self):
        ...
        self.assertTrue(
            type(val) == list,
            f"Function {function} does not return list with parameter value [1,2].",
        )
        ...
        for test_case in test_cases:
            with patch(
                ...
                self.assertEqual(
                    correct,
                    test_result,
                    f"The result {test_result} does not match with the expected resul {correct} when calling distinct_numbers({test_case2})",
                )
                self.assertEqual(
                    test_case,
                    test_case2,
