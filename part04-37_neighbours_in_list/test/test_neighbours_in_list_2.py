...
class NeigboursInListTest(unittest.TestCase):
    ...
    def test_4_lists_2(self):
        test_cases = {
            (1, 2, 3, 0, 1, 2, 3, 4, 5, 3, 4, 5, 1, 2, 3): 6,
        ...
        for test_case in test_cases:
            with patch(
                ...
                self.assertEqual(
                    correct,
                    test_result,
                    f"The result {test_result} does not match with the model solution {correct} with the test input {test_case2}.",
                )
                self.assertEqual(
                    test_case,
                    test_case2,
    ...
    def test_5_lists_3(self):
        test_cases = {
            (1, 2, 3, 5, 6, 7, 6, 5, 6, 7, 10, 11, 10): 7,
