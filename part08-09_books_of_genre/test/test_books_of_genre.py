...
"""
    ...
    def test1_function_exists(self):
        try:
            ...
            self.fail(
                "Your program should have a function books_of_genre(books: list, genre: str)"
            )
    ...
    def test2_return_type(self):
        try:
            ...
            self.assertTrue(
                type(val) == list,
                f"Function books_of_genre should return a list,"
            ...
            self.fail(
                f"Function threw an error when called with arguments\n"
    ...
    def test3_test_list1(self):
        ...
        with patch(
            ...
            corr = sorted(
                [x for x in book_list if x.genre == genre], key=lambda x: x.name
            )
            ...
            self.assertEqual(
                corr,
                val,
                f"Function should return values\n{corr}\nNow it returns\n{val}\n...when arguments were\n{test_case}",
            )
