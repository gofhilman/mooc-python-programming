...
"""
    ...
    def test2_constructor(self):
        try:
            ...
            self.fail("Calling constructor Clock(12,0,0)" + f" threw an error: {e}")
        ...
        for test_case in test_cases:
            try:
                ...
                self.assertEqual(
                    corr,
                    val,
                    f"Method __str__ should return string {corr}\nwhen object was created as\n"
    ...
    def test4_test_tick(self):
        ...
        for test_case in test_cases:
            try:
                ...
                corr = (datetime(2000, 1, 1, h, m, s) + timedelta(seconds=t)).strftime(
                    "%H:%M:%S"
                )
                val = str(clock)
