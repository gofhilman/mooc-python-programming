...
"""
    ...
    def test_1_function_exists(self):
        try:
            ...
            self.assertTrue(
                False,
                "Your code should contain function named as no_shouting(my_list: list)",
            )
        try:
            from src.no_shouting_allowed import no_shouting
            ...
            self.assertTrue(
                False,
                'Make sure, that function can be called as follows no_shouting(["Abc"])',
            )
    ...
    def test_2_no_return_value(self):
        ...
        self.assertTrue(
            type(val) == list,
            f'Function {function} does not return list when calling \nno_shouting(["Abc"])',
        )
