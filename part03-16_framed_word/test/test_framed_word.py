        ...
        for word in words:
            with patch("builtins.input", return_value=word):
                ...
                self.assertEqual(
                    output[0],
                    "*" * 30,
                    "First row of your print out does not consist of 30 stars: {}".format(
                        output[0]
                    ),
                )
                self.assertEqual(
                    output[2],
                    "*" * 30,
                    "Last row of your print out does not consist of 30 stars: {}".format(
                        output[2]
                    ),
                )
                ...
                self.assertTrue(
                    len(output[1]) == 30,
                    "Length of middle row is {}, instead of 30, when input is {}: \n{}".format(
                        len(output[1]), word, output[1]
                    ),
                )
