        ...
        for test_case in test_cases:
            with patch(
                ...
                self.assertEqual(
                    len(correct),
                    len(output),
                    f"The amount of the rows printed out is incorrect with the test input {test_case}. Your function printed out {len(output)} rows, correct amount is {len(correct)}",
                )
                self.assertEqual(
                    correct,
                    output,
